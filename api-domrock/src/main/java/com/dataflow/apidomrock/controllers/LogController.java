...
public class LogController {
    ...
    @GetMapping("allUsers")
    public ResponseEntity<ResponseCustomDTO<List<UserDTO>>> findAllUsers() throws CustomException{
        return ResponseEntity.ok().body(new ResponseCustomDTO<>("Processamento efetuado com sucesso", logger.findAllUsers()));
    }
}